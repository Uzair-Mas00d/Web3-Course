...
export class ItemCancled extends ethereum.Event {
  get params(): ItemCancled__Params {
    return new ItemCancled__Params(this);
  }
}

export class ItemCancled__Params {
  _event: ItemCancled;

  constructor(event: ItemCancled) {
    this._event = event;
  }
